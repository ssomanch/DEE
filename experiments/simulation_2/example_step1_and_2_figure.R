...
LORD3_results = fread(paste0('../output/simulation_2/',seed1,'/',CATE_ls,'/',bias_ls,'/LORD3_results.csv'))
...
dir.create('../output/simulation_2/summary_figures/voroni_evolution/', showWarnings = FALSE)
voroni_assets = get_voroni_knn_discontinuities_index_sets_and_estimates(
	L_x, L_v, df, k_prime, t_partition, estimator,
	save_plots='../output/simulation_2/summary_figures/voroni_evolution/',
	R2_figure=T
)
...
ggsave('../output/simulation_2/summary_figures/grid_step1_step2.png',m,width=10,height=5)
...
m = grid.arrange(p2a,p1a,widths=c(4,4),heights=c(4))
ggsave('../output/simulation_2/summary_figures/side_by_side_spread_and_overlap.png',m,width=10,height=5)
...
ggsave('../output/simulation_2/summary_figures/just_left_1.png',m,width=4,height=4)

m = grid.arrange(p1, p2a, widths=c(4,4),heights=c(4))
ggsave('../output/simulation_2/summary_figures/just_left_2.png',m,width=8,height=4)

m = grid.arrange(p1, p2a, p2, widths=c(4,4,4),heights=c(4))
ggsave('../output/simulation_2/summary_figures/all_3_versions.png',m,width=12,height=4)